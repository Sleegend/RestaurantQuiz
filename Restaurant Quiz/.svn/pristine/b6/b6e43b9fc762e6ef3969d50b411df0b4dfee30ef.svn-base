...
public class TranslinkService extends AbstractTranslinkService {
	 ...
	 */
	private final static String APIKEY = "Ejqccw9euNmmjd3LuCbZ";  // insert your Translink key here
    ...
    public void addWaitTimeEstimatesToStop(BusStop stop) throws TranslinkException {
		StringBuilder uriBuilder = new StringBuilder(
				...
				//"//api.translink.ca/rttiapi/v1/stops/60980/estimates?apikey=Ejqccw9euNmmjd3LuCbZ&count=3&timeframe=60");
		//uriBuilder.append(stop + "/estimates?apikey=" + APIKEY);
    ...
    public void addBusLocationsForStop(BusStop stop)
		...
		StringBuilder uriBuilder = new StringBuilder(
				"//api.translink.ca/rttiapi/v1/");
				//http://api.translink.ca/rttiapi/v1/stops/55612?apikey=Ejqccw9euNmmjd3LuCbZ
				//http://api.translink.ca/rttiapi/v1/buses?apikey=Ejqccw9euNmmjd3LuCbZ&stopNo=53987
